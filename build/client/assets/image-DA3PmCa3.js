import{r,j as f}from"./jsx-runtime-CbkKSL4Y.js";import{c as R,g as N,t as L,h as C,a as P,n as E,u as q,B as Q,I as J}from"./heading-DgiZnZYf.js";const X="/assets/gotham-bold-italic-C_msAlmW.woff2",Y="/assets/gotham-bold-D1kvQ7KV.woff2",Z="/assets/gotham-book-italic-Bm2IEtSK.woff2",ee="/assets/gotham-book-Bnaws0Ef.woff2",te="/assets/gotham-medium-italic-Dok430ou.woff2",oe="/assets/gotham-medium-0VT3RO8I.woff2",ae="/assets/ipa-gothic-DimHCOud.woff2",z=r.createContext({}),Ie=({theme:e="dark",children:t,className:n,as:a="div",toggleTheme:i,...s})=>{const o=W(),c=!o.theme;return f.jsxs(z.Provider,{value:{theme:e,toggleTheme:i||o.toggleTheme},children:[c&&t,!c&&f.jsx(a,{className:R(n),"data-theme":e,...s,children:t})]})};function W(){return r.useContext(z)}function p(e){return e.replace(/\s\s+/g," ")}function j(e){return p(Object.keys(e).map(t=>`--${t}: ${e[t]};`).join(`
